...
create table user (id bigint generated by default as identity (start with 1), enabled varchar(255), password varchar(255), username varchar(255), primary key (id));
