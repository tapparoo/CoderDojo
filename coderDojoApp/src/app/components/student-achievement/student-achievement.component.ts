...
export class StudentAchievementComponent implements OnInit {
  ...
  getStudentUserAchievements(student: UserDetail) {
    this.userAchievementService
      .getUserAchievementsByUserDetail(student)
      .subscribe(
        data => {
  ...
  achievedCheckBox(userAchievement: UserAchievement) {
    ...
    this.userAchievementService
      .update(userAchievement, this.selectedStudent)
      .subscribe(
        data => {
  ...
  addAchievementToUser() {
    ...
    this.userAchievementService
      .create(this.newUserAchievement, this.selectedStudent.user.username)
      .subscribe(
        data => {
          this.index();
        },
  ...
  deleteUserAchievement() {
    this.userAchievementService
      .destroy(this.selectedUserAchievement.id)
      .subscribe(
        data => {
          this.index();
        },
